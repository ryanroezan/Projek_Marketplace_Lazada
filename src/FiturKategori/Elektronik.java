...
public class Elektronik {
    String produk, JasaKirim;
    int HargaProduk, BiayaOngkir, DiskonOngkir, DiskonBarang;
    Scanner user =new Scanner(System.in);
    //method
    public void produk(){
        System.out.println("");
        System.out.println("Categories Elektronik");
        System.out.println("-Digital TV Samsung- Rp. 3000000");
    }
    //method
    public void Beli(){
        produk="Digital TV Samsung";
        HargaProduk = 3000000;
    //Jasa Pengiriman   
    System.out.println("");
