...
//konsep Constructor
public class Laptop{
    String produk, JasaKirim, NamaProduk;
    int HargaProduk, BiayaOngkir, DiskonOngkir, DiskonBarang,Harga;
    Scanner user =new Scanner(System.in);
    //Constructor
    public Laptop(String NamaProduk, int Harga){
        this.NamaProduk=NamaProduk; this.Harga=Harga;
    }
    //method
    public void produk(){
        System.out.println("");
        System.out.println("Categories Laptop");
        System.out.println("-"+NamaProduk+"- Rp. "+Harga);
    }
    //method
    public void Beli(){
        produk=NamaProduk;
